...
with open('/home/dans/Documents/Uni/DM_project/files/modified/artists.csv', newline='', encoding='utf-8') as infile:
...
# -------------------- Caricamento TRACKS --------------------
with open('/home/dans/Documents/Uni/DM_project/files/modified/tracks.csv', newline='', encoding='utf-8') as infile:
    reader = csv.DictReader(infile)
    for row in reader:
        try:
