...
def load_mongodb():
    ...
    df2 = pd.read_csv('/home/dans/Documents/Uni/DM_project/mongo/init/tracks.csv', encoding='utf-8', encoding_errors='replace')
    ...
    df1 = pd.read_csv('/home/dans/Documents/Uni/DM_project/mongo/init/artists.csv')
